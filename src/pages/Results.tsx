...
import { loadImage } from "@/lib/mediapipe";
import { 
  drawSimplifiedMidlineOverlay, 
  drawSimplifiedProportionsOverlay, 
  drawSimplifiedSmileOverlay 
} from "@/components/OverlayGenerator";
