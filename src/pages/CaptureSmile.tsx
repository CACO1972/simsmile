...
export default function CaptureSmile() {
  ...
  const { restImage, smileImage, setSmileImage } = useSmileAnalysis();
  const [showCamera, setShowCamera] = useState(false);

  // Proteger ruta: redirigir si no hay foto de reposo
  useEffect(() => {
    if (!restImage) {
      ...
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-medium text-muted-foreground">Paso 3 de 6</span>
        ...
        <div className="bg-card rounded-2xl border border-border overflow-hidden shadow-lg">
          <div className="bg-primary/10 p-6 border-b border-border">
            ...
            <p className="text-muted-foreground">
              Muestra tu mejor sonrisa natural
            </p>
          </div>
              ...
              <>
                ...
                <div className="bg-accent/20 p-4 rounded-lg">
                  <p className="text-sm text-foreground leading-relaxed">
                    💡 <strong>Consejo:</strong> Sonríe de forma natural mostrando tus dientes. No fuerces la sonrisa, imagina algo que te haga feliz.
                  </p>
                </div>
                ...
                <div className="bg-green-500/10 border border-green-500/20 p-4 rounded-lg">
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-sm text-foreground">
                      <strong>¡Excelente!</strong> Foto sonriendo capturada correctamente
                    </p>
                  </div>
                </div>
